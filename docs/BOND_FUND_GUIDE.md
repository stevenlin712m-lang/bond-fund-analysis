...
1. 从成立日开始获取全部历史净值，计算收益、波动、回撤、夏普、索提诺、
   卡尔玛、VaR、CVaR、胜率、盈亏比和最大连续亏损天数；
2. 自动下载并解析最新季报、半年报或年报，提取资产配置、经理观点和债券持仓。

“成立以来历年收益”会列出基金成立年份至今的每一个年份。首个成立年度和
当前尚未结束的年度标记为“非完整年度”；完整年度按上一年末净值至当年末净值计算。
